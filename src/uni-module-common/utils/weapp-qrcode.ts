...
(function () {
    ...
    QRCode = function (canvasId, vOption) {
        ...
        console.log('QRCode---function---', this, this._htOption)
    ...
    QRCode.prototype.makeCode = function (sText) {
        ...
        console.log('QRCode---makeCode---', this )
    ...
    QRCode.prototype.makeImage = function () {
        ...
        if (this._htOption.usingIn) {
          console.log('QRCode---makeImage---if---', this._htOption.usingIn, this)
          ...
          console.log('QRCode---makeImage---else---', this._htOption.canvasRef, this._htOption.usingIn)
          _oContext = wx.createCanvasContext(this.canvasId, this._htOption.canvasRef)
        }
