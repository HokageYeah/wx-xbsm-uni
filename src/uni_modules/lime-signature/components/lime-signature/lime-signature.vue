<template>
  <view class="signature" :class="{ landscape }">
    ...
    <view v-if="landscape" class="signature-area">
      <l-signature
        ref="signatureRef"
        :key="landscape"
        disable-scroll
    ...
    <view class="tools">
      <view class="tools-item" @tap="isShowPen = !isShowPen">
        ...
        <image
          ...
          src="https://fastly.jsdelivr.net/gh/liangei/image@latest/brush-fill.svg"
          mode="widthFix"
        ></image>
        <!-- #endif -->
      </view>
      <view class="tools-item" @tap="onClick('undo')">
        ...
        <image
          class="tools-item__image"
          src="https://fastly.jsdelivr.net/gh/liangei/image@latest/reply-fill.svg"
          mode="widthFix"
        ></image>
        <!-- #endif -->
      </view>
      ...
      <view class="tools-item" @tap="onClick('clear')">
        ...
        <image
          class="tools-item__image"
          src="https://fastly.jsdelivr.net/gh/liangei/image@latest/brush-2-fill.svg"
          mode="widthFix"
        ></image>
        <!-- #endif -->
      </view>
      <view class="tools-item" @tap="onClick('save')">
        ...
        <image
          class="tools-item__image"
          src="https://fastly.jsdelivr.net/gh/liangei/image@latest/save-fill.svg"
          mode="widthFix"
        ></image>
        <!-- #endif -->
      </view>
      <view class="tools-item" @tap="onClick('save2')">
        <!-- #ifdef APP-NVUE -->
        <text>保存</text>
        <!-- #endif -->
        <!-- #ifndef APP-NVUE -->
        ...
        <view class="popup-item">
          <view class="popup-item__head">
            ...
            <view class="popup-item__more">
              ...
              <switch
                class="popup-item__more-switch"
                :checked="openSmooth"
                @change="() => (openSmooth = !openSmooth)"
              />
            </view>
          </view>
          <view class="popup-item__head">
          ...
          <slider :value="penSize" max="20" show-value @change="penSize = $event.detail.value" />
        </view>
      </view>
    </uni-popup>
    <!-- <view class="buttons">
    ...
    <view v-if="url" class="signature-preview">
